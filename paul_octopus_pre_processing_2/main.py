...
v_path_datasets = 'paul_octopus_pre_processing_2/datasets/just_participants/'
...
def generate_features_dataset():
    ...
    writer.write_datasets(v_path_datasets + 'all_score/32_or_1_year', dataset_train, dataset_test, dataset_2022)  
...
def read_features_dataset():
    ...
    writer.plot_histogram_goals(v_path_datasets + 'all_score/32_or_1_year/data_visualization/train_', dataset_train)
    writer.plot_histogram_goals(v_path_datasets + 'all_score/32_or_1_year/data_visualization/test_', dataset_test)
